...
// ../.wrangler/tmp/bundle-PluIJM/checked-fetch.js
...
// ../node_modules/.pnpm/hono@4.12.27/node_modules/hono/dist/adapter/cloudflare-pages/handler.js
...
app.post("/upload-avatar", authMiddleware, async (c) => {
  ...
  try {
    ...
    await c.env.DB.prepare("UPDATE users SET avatar_url = ? WHERE username = ?").bind(avatarUrl, username).run();
...
app.post("/register", async (c) => {
  ...
  try {
    ...
    await c.env.DB.prepare("INSERT INTO users (username, password_hash) VALUES (?, ?)").bind(username, hashed).run();
    return c.json({
      message: "\u6CE8\u518C\u6210\u529F",
...
app.post("/login", async (c) => {
  ...
  try {
    const hashed = await hashPassword(password);
    const { results } = await c.env.DB.prepare("SELECT * FROM users WHERE username = ? AND password_hash = ?").bind(username, hashed).all();
    if (results && results.length > 0) {
      return c.json({
        message: "\u767B\u5F55\u6210\u529F",
        token: `real-jwt-token-for-${username}`
...
// ../.wrangler/tmp/pages-fx82gf/functionsRoutes-0.4138708906080336.mjs
var routes = [
  {
    routePath: "/api/:route*",
    mountPath: "/api",
...
// ../node_modules/.pnpm/wrangler@4.105.0_@cloudflare+workers-types@4.20260626.1/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../node_modules/.pnpm/wrangler@4.105.0_@cloudflare+workers-types@4.20260626.1/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../node_modules/.pnpm/wrangler@4.105.0_@cloudflare+workers-types@4.20260626.1/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-PluIJM/middleware-insertion-facade.js
...
// ../node_modules/.pnpm/wrangler@4.105.0_@cloudflare+workers-types@4.20260626.1/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-PluIJM/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8588812409873808.mjs.map
